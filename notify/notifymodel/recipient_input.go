...
// indefensible.
func (i *NotificationRecipientCreateInput) Normalize() {
...
// NotificationRecipientCreateInputError says what was wrong with each field of
// a NotificationRecipientCreateInput.
//
...
// the 422 carries.
type NotificationRecipientCreateInputError struct {
	// What happened. The line is separate from it so that one person clearing
	// their inbox changes nothing anybody else sees.
...
func (e *NotificationRecipientCreateInputError) Empty() bool {
	if e == nil {
		return true
	}
...
func (e *NotificationRecipientCreateInputError) Error() string {
	var parts []string
...
func (e *NotificationRecipientCreateInputError) ErrorCode() rigerr.Code {
...
func (e *NotificationRecipientCreateInputError) ErrorFields() any { return e }
...
//
// What comes back is a *NotificationRecipientCreateInputError, shaped like the
// input itself.
func (i *NotificationRecipientCreateInput) Validate() error {
	var failed NotificationRecipientCreateInputError
...
// NotificationRecipientUpdateInput is what changing a NotificationRecipient
// takes.
//
...
type NotificationRecipientUpdateInput struct {
	// What happened. The line is separate from it so that one person clearing
	// their inbox changes nothing anybody else sees.
...
func (i *NotificationRecipientUpdateInput) Normalize() {
...
func (i NotificationRecipientUpdateInput) Merged(prev *NotificationRecipient) NotificationRecipient {
	out := *prev
...
// NotificationRecipientUpdateInputError says what was wrong with each field of
// a NotificationRecipientUpdateInput.
//
// Its shape is the input's shape, so a client can attach every message to the
// field it is about without matching on strings. A member is nil when that
// field was fine, and the whole value is nil when the input was. It is what
// the 422 carries.
type NotificationRecipientUpdateInputError struct {
	// What happened. The line is separate from it so that one person clearing
	// their inbox changes nothing anybody else sees.
	NotificationID *rigerr.FieldError `json:"notificationId,omitempty"`
	// Who this line is for. An account rather than an identity: an identity has no
...
// Empty reports whether anything went wrong. A validator that found nothing
// returns nil rather than one of these.
func (e *NotificationRecipientUpdateInputError) Empty() bool {
	if e == nil {
		return true
	}
...
// Error implements error. The sentence is for logs and for a person; the
// structure above is what a client acts on.
func (e *NotificationRecipientUpdateInputError) Error() string {
	var parts []string
	if e.NotificationID != nil {
		parts = append(parts, "notificationId "+e.NotificationID.Error())
	}
...
// ErrorCode implements [rigerr.Coder]: the request was understood and its
// content is what is wrong, which is 422 and not 400.
func (e *NotificationRecipientUpdateInputError) ErrorCode() rigerr.Code {
	return rigerr.CodeUnprocessableEntity
}

// ErrorFields implements [rigerr.FieldReporter], which is how the HTTP layer
// finds this and answers with it rather than with prose.
func (e *NotificationRecipientUpdateInputError) ErrorFields() any { return e }
...
//
// What comes back is a *NotificationRecipientUpdateInputError, shaped like the
// input itself.
func (i *NotificationRecipientUpdateInput) Validate(prev *NotificationRecipient) error {
	var failed NotificationRecipientUpdateInputError
...
// NotificationRecipientDeleteInput is what deleting a NotificationRecipient
// takes.
type NotificationRecipientDeleteInput struct {
...
// NotificationRecipientValidatorContext is what a rule sees.
//
...
type NotificationRecipientValidatorContext struct {
	...
	previous NotificationRecipient
	isUpdate bool
	changed  map[string]bool
}

// IsUpdate reports whether there was a row before this.
func (c *NotificationRecipientValidatorContext) IsUpdate() bool { return c.isUpdate }

// Previous is the row as it was, and the zero value on a create. Check
// IsUpdate before reading it.
func (c *NotificationRecipientValidatorContext) Previous() NotificationRecipient { return c.previous }
...
// everything is new.
func (c *NotificationRecipientValidatorContext) Changed(column string) bool { return c.changed[column] }

// NotificationIDChanged reports whether this request set notification_id.
func (c *NotificationRecipientValidatorContext) NotificationIDChanged() bool {
	return c.changed[ColumnNotificationRecipientNotificationID]
}

// AccountIDChanged reports whether this request set account_id.
func (c *NotificationRecipientValidatorContext) AccountIDChanged() bool {
	return c.changed[ColumnNotificationRecipientAccountID]
}

// KindChanged reports whether this request set kind.
func (c *NotificationRecipientValidatorContext) KindChanged() bool {
	return c.changed[ColumnNotificationRecipientKind]
}

// GroupKeyChanged reports whether this request set group_key.
func (c *NotificationRecipientValidatorContext) GroupKeyChanged() bool {
	return c.changed[ColumnNotificationRecipientGroupKey]
}

// EventCountChanged reports whether this request set event_count.
func (c *NotificationRecipientValidatorContext) EventCountChanged() bool {
	return c.changed[ColumnNotificationRecipientEventCount]
}

// ReadAtChanged reports whether this request set read_at.
func (c *NotificationRecipientValidatorContext) ReadAtChanged() bool {
	return c.changed[ColumnNotificationRecipientReadAt]
}

// NotificationRecipientCreateValidator is the rules for bringing a
// NotificationRecipient into existence: what the schema cannot express.
//
...
type NotificationRecipientCreateValidator struct {
	// What happened. The line is separate from it so that one person clearing
	// their inbox changes nothing anybody else sees.
	NotificationID func(ctx context.Context, c *NotificationRecipientValidatorContext, value uuid.UUID) error
	// Who this line is for. An account rather than an identity: an identity has no
	// tenant, so a row addressed to one would fall outside every generated query.
	AccountID func(ctx context.Context, c *NotificationRecipientValidatorContext, value uuid.UUID) error
	// Copied from the notification, so the inbox and its live-sync shape never
	// touch a table holding rows for people who are not recipients.
	Kind func(ctx context.Context, c *NotificationRecipientValidatorContext, value string) error
	// What collapses several events into one line. Null opts out and every event
	// is its own row.
	GroupKey func(ctx context.Context, c *NotificationRecipientValidatorContext, value *string) error
	// How many events this line stands for. One unless a group key collapsed them.
	EventCount func(ctx context.Context, c *NotificationRecipientValidatorContext, value int) error
	// When the person read it. Null is unread, which is what the badge counts.
	ReadAt func(ctx context.Context, c *NotificationRecipientValidatorContext, value *time.Time) error

	// Entity runs after the per-field hooks, for a rule that is about the row
	// rather than about one column.
	Entity func(ctx context.Context, c *NotificationRecipientValidatorContext) error
}
...
func (v NotificationRecipientCreateValidator) RunCreate(ctx context.Context, claims tenancy.Claims, i *NotificationRecipientCreateInput) error {
	// Everything is new, so everything counts as changed.
	c := &NotificationRecipientValidatorContext{Claims: claims, changed: map[string]bool{}}
	c.Values.NotificationID = i.NotificationID
	c.changed[ColumnNotificationRecipientNotificationID] = true
	c.Values.AccountID = i.AccountID
	c.changed[ColumnNotificationRecipientAccountID] = true
	c.Values.Kind = i.Kind
	c.changed[ColumnNotificationRecipientKind] = true
	c.Values.GroupKey = i.GroupKey
	c.changed[ColumnNotificationRecipientGroupKey] = true
	c.Values.EventCount = i.EventCount
	c.changed[ColumnNotificationRecipientEventCount] = true
	c.Values.ReadAt = i.ReadAt
	c.changed[ColumnNotificationRecipientReadAt] = true
...
func (v NotificationRecipientCreateValidator) run(ctx context.Context, c *NotificationRecipientValidatorContext) (*NotificationRecipientCreateInputError, error) {
	var failed NotificationRecipientCreateInputError
...
// NotificationRecipientUpdateValidator is the rules for changing one that
...
// A hook returns a FieldError to attach the message to a specific field, or
// any other error to fail the request outright.
type NotificationRecipientUpdateValidator struct {
	// What happened. The line is separate from it so that one person clearing
	// their inbox changes nothing anybody else sees.
	NotificationID func(ctx context.Context, c *NotificationRecipientValidatorContext, value uuid.UUID) error
	// Who this line is for. An account rather than an identity: an identity has no
...
func (v NotificationRecipientUpdateValidator) RunUpdate(ctx context.Context, claims tenancy.Claims, i *NotificationRecipientUpdateInput, prev *NotificationRecipient) error {
	c := &NotificationRecipientValidatorContext{
	...
	c.changed[ColumnNotificationRecipientNotificationID] = i.NotificationID.IsSet()
	c.changed[ColumnNotificationRecipientAccountID] = i.AccountID.IsSet()
	c.changed[ColumnNotificationRecipientKind] = i.Kind.IsSet()
	c.changed[ColumnNotificationRecipientGroupKey] = i.GroupKey.Touched()
	c.changed[ColumnNotificationRecipientEventCount] = i.EventCount.IsSet()
	c.changed[ColumnNotificationRecipientReadAt] = i.ReadAt.Touched()
...
// is returning to.
func (v NotificationRecipientUpdateValidator) RunRestore(ctx context.Context, claims tenancy.Claims, i *NotificationRecipientUpdateInput, prev *NotificationRecipient) error {
	c := &NotificationRecipientValidatorContext{
		Values:   i.Merged(prev),
		Claims:   claims,
		previous: *prev,
...
// their input, so it comes back wrapped with the rule that could not be run,
// keeping whatever code it carried and becoming Internal if it carried none.
func (v NotificationRecipientUpdateValidator) run(ctx context.Context, c *NotificationRecipientValidatorContext) (*NotificationRecipientUpdateInputError, error) {
	var failed NotificationRecipientUpdateInputError
