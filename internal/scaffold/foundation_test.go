...
func TestWantedExpandsToPartsInOrder(t *testing.T) {
	...
	everything := []string{"tenancy", "apikeys", "sessions", "oauth", "verification_delivery", "last_tenant", "notifications", "idempotency", "throttle"}
	...
	cases := []struct {
		...
		},
		{
			...
			[]string{"tenancy", "apikeys", "sessions", "oauth", "verification_delivery", "last_tenant", "idempotency", "throttle"},
		},
		{
