...
type RigAccountService interface {
	...
	// Create a RigAccount.
	Create(ctx context.Context, r Request[struct{}, struct{}, model.RigAccountCreateInput]) (*model.RigAccount, error)

	// Search RigAccounts with filters.
	Search(ctx context.Context, r Request[struct{}, RigAccountSearchQuery, RigAccountSearchBody]) (*RigAccountListResponse, error)

	// Delete a RigAccount.
	Delete(ctx context.Context, r Request[RigAccountDeletePath, struct{}, struct{}]) error
	...
	Update(ctx context.Context, r Request[RigAccountUpdatePath, struct{}, model.RigAccountUpdateInput]) (*model.RigAccount, error)
}
...
// Create implements RigAccountService.
func (s DefaultRigAccountService) Create(ctx context.Context, r Request[struct{}, struct{}, model.RigAccountCreateInput]) (*model.RigAccount, error) {
	return s.write.Create(ctx, r.Body)
}

// Search implements RigAccountService.
func (s DefaultRigAccountService) Search(ctx context.Context, r Request[struct{}, RigAccountSearchQuery, RigAccountSearchBody]) (*RigAccountListResponse, error) {
	page := model.RigAccountPage{Limit: r.Query.Limit, Offset: r.Query.Offset}
	asked := r.Body.Filter
	filter, err := s.readFilter(ctx, r.Claims, asked)
	if err != nil {
...
// Delete implements RigAccountService.
func (s DefaultRigAccountService) Delete(ctx context.Context, r Request[RigAccountDeletePath, struct{}, struct{}]) error {
	return s.write.Delete(ctx, model.RigAccountDeleteInput{ID: r.Path.ID})
}
...
// Update implements RigAccountService.
func (s DefaultRigAccountService) Update(ctx context.Context, r Request[RigAccountUpdatePath, struct{}, model.RigAccountUpdateInput]) (*model.RigAccount, error) {
