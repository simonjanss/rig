...
func (r *lessonRepo) trace(ctx context.Context, name string, f func(context.Context) error) error {
...
func (r *lessonRepo) Get(ctx context.Context, id uuid.UUID, opts ...readopt.Option) (*model.Lesson, error) {
	ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.Get")
	defer span.End()
...
func (r *lessonRepo) List(ctx context.Context, f model.LessonFilter, page model.LessonPage, opts ...readopt.Option) ([]*model.Lesson, int64, error) {
	ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.List")
	defer span.End()
...
func (r *lessonRepo) Create(ctx context.Context, in dbhook.Create[model.LessonCreateInput, model.Lesson]) (*model.Lesson, error) {
	ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.Create")
	defer span.End()
	...
	if in.Hooks.Validator != nil {
		if err := r.trace(ctx, "repository.Lesson.Create.Validator", func(ctx context.Context) error {
	...
	err = dbx.InTxIf(ctx, r.db.pool, r.db.conn(), needsTx, func(ctx context.Context, tx dbx.Conn) error {
		...
		if in.Hooks.After != nil {
			if err := r.trace(ctx, "repository.Lesson.Create.After", func(ctx context.Context) error {
	...
	if in.Hooks.AfterCommit != nil {
		...
		dbx.AfterCommit(ctx, func() {
			ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.Create.AfterCommit")
			defer span.End()
...
func (r *lessonRepo) Update(ctx context.Context, id uuid.UUID, in dbhook.Update[model.LessonUpdateInput, model.Lesson]) (*model.Lesson, error) {
	ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.Update")
	defer span.End()
	...
	err = dbx.InTx(ctx, r.db.pool, func(ctx context.Context, tx dbx.Conn) error {
		...
		// checked.
		if in.Hooks.Before != nil {
			if err := r.trace(ctx, "repository.Lesson.Update.Before", func(ctx context.Context) error {
		...
		if in.Hooks.Validator != nil {
			if err := r.trace(ctx, "repository.Lesson.Update.Validator", func(ctx context.Context) error {
		...
		if in.Hooks.After != nil {
			if err := r.trace(ctx, "repository.Lesson.Update.After", func(ctx context.Context) error {
	...
	if in.Hooks.AfterCommit != nil {
		...
		dbx.AfterCommit(ctx, func() {
			ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.Update.AfterCommit")
			defer span.End()
...
func (r *lessonRepo) writeSnapshot(ctx context.Context, tx dbx.Conn, prev *model.Lesson) error {
	ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.writeSnapshot")
	defer span.End()
...
func (r *lessonRepo) Delete(ctx context.Context, in dbhook.Delete[model.LessonDeleteInput, model.Lesson]) error {
	ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.Delete")
	defer span.End()
	...
	err = dbx.InTx(ctx, r.db.pool, func(ctx context.Context, tx dbx.Conn) error {
		...
		if in.Hooks.Before != nil {
			if err := r.trace(ctx, "repository.Lesson.Delete.Before", func(ctx context.Context) error {
				return in.Hooks.Before(ctx, claims, &in.Input, prev)
			}); err != nil {
				return err
			}
		...
		if in.Input.Hard {
			...
			if in.Hooks.After != nil {
				if err := r.trace(ctx, "repository.Lesson.Delete.After", func(ctx context.Context) error {
	...
	if in.Hooks.AfterCommit != nil {
		...
		dbx.AfterCommit(ctx, func() {
			ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.Delete.AfterCommit")
			defer span.End()
...
func (r *lessonRepo) Restore(ctx context.Context, id uuid.UUID, in dbhook.Restore[model.LessonUpdateInput, model.Lesson]) (*model.Lesson, error) {
	ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.Restore")
	defer span.End()
	...
	err = dbx.InTx(ctx, r.db.pool, func(ctx context.Context, tx dbx.Conn) error {
		...
		// restore instead.
		if in.Hooks.Before != nil {
			if err := r.trace(ctx, "repository.Lesson.Restore.Before", func(ctx context.Context) error {
				return in.Hooks.Before(ctx, claims, &in.Input, prev)
			}); err != nil {
				return err
			}
		...
		if in.Hooks.Validator != nil {
			if err := r.trace(ctx, "repository.Lesson.Restore.Validator", func(ctx context.Context) error {
		...
		if in.Hooks.After != nil {
			if err := r.trace(ctx, "repository.Lesson.Restore.After", func(ctx context.Context) error {
	...
	if in.Hooks.AfterCommit != nil {
		...
		dbx.AfterCommit(ctx, func() {
			ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.Restore.AfterCommit")
			defer span.End()
...
func (r *lessonRepo) ListDeleted(ctx context.Context, f model.LessonFilter, page model.LessonPage, opts ...readopt.Option) ([]*model.Lesson, int64, error) {
	ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.ListDeleted")
	defer span.End()
...
func (r *lessonRepo) ListSnapshots(ctx context.Context, id uuid.UUID) ([]*model.Lesson, error) {
	ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.ListSnapshots")
	defer span.End()
...
func (r *lessonRepo) Revert(ctx context.Context, id, versionID uuid.UUID, hooks dbhook.UpdateHooks[model.LessonUpdateInput, model.Lesson]) (*model.Lesson, error) {
	ctx, span := r.db.tracer.Start(ctx, "repository.Lesson.Revert")
	defer span.End()
