...
//		// ...
//		Shutdown: api.Shutdown{Shapes: 2 * time.Second},
//	}, build)
//
...
//
// The only field is Shapes, because that is the one step this project's
...
func (s Shutdown) Budget() time.Duration {
	return cmp.Or(s.Shapes, shapesShutdown) + shutdownHeadroom
}
