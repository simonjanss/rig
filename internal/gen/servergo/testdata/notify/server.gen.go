...
func Register(h Handlers) *http.ServeMux {
	...
	if h.BlogPost != nil {
		registerBlogPost(mux, h.Server, h.BlogPost)
	}
	if h.RigAccount != nil {
	...
	if h.Shapes.Proxy != nil {
		...
		mux.HandleFunc("GET /api/v1/rig_notification_recipient/_stream", handleRigNotificationRecipientShape(h.Server, h.Shapes))
		mux.HandleFunc("GET /api/v1/rig_notification_recipient/_deleted/_stream", handleRigNotificationRecipientDeletedShape(h.Server, h.Shapes))
