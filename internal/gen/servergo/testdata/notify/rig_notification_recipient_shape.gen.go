...
func handleRigNotificationRecipientShape(s Server, sh Shapes) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if sh.RigNotificationRecipient != nil {
			if err := sh.RigNotificationRecipient(ctx, r, claims, params, where); err != nil {
				fail(s, w, r, rc, err)
				return
			}
		}
...
func handleRigNotificationRecipientDeletedShape(s Server, sh Shapes) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		ctx, claims, rc, ok := prepare(s, w, r)
		if !ok {
			return
		...
		if sh.RigNotificationRecipientDeleted != nil {
			if err := sh.RigNotificationRecipientDeleted(ctx, r, claims, params, where); err != nil {
				fail(s, w, r, rc, err)
				return
			}
		}
