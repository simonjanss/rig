...
// around it has to care: the routes to serve, and the sync proxy and the auth
// cache's invalidation channel — the things whose lifetime is longer than a
// request's.
//
...
//			MaxShutdown:       25 * time.Second, // ShutdownBudget()
