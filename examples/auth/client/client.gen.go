...
// Package client is the generated Go client for the auth API, version v1. One
...
const (
	...
	ServerLocal = "http://localhost:8082"
)
...
const DefaultBaseURL = ServerLocal
