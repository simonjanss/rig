...
// notificationNotesFilter collects the conditions written on a Notification's
// Notes.
//
...
func notificationNotesFilter(f model.NotificationFilter) (model.NoteFilter, bool) {
	var (
...
func notificationGroup(f model.NotificationFilter, sc filterScope) (query.Group, error) {
	...
	if sub, ok := notificationNotesFilter(f); ok {
