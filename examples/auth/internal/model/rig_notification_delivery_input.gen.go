...
// RigNotificationDeliveryCreateInput is what creating a
// RigNotificationDelivery takes.
//
// The identifier, the tenant, and the audit columns are absent: those are
// stamped by the repository from the request's claims.
type RigNotificationDeliveryCreateInput struct {
...
// indefensible.
func (i *RigNotificationDeliveryCreateInput) Normalize() {
	...
	if v, ok := ParseRigNotificationDeliveryState(string(i.State)); ok {
		i.State = v
	}
	if i.State == "" {
		i.State = RigNotificationDeliveryStatePending
	}
...
// RigNotificationDeliveryCreateInputError says what was wrong with each field
// of a RigNotificationDeliveryCreateInput.
//
...
// the 422 carries.
type RigNotificationDeliveryCreateInputError struct {
	// The inbox line this is a copy of. The line is the truth and this is one way
	// it was repeated.
...
func (e *RigNotificationDeliveryCreateInputError) Empty() bool {
	if e == nil {
		return true
	}
...
func (e *RigNotificationDeliveryCreateInputError) Error() string {
	var parts []string
...
func (e *RigNotificationDeliveryCreateInputError) ErrorCode() rigerr.Code {
...
func (e *RigNotificationDeliveryCreateInputError) ErrorFields() any { return e }
...
//
// What comes back is a *RigNotificationDeliveryCreateInputError, shaped like
// the input itself.
func (i *RigNotificationDeliveryCreateInput) Validate() error {
	var failed RigNotificationDeliveryCreateInputError
...
// RigNotificationDeliveryUpdateInput is what changing a
// RigNotificationDelivery takes.
//
...
type RigNotificationDeliveryUpdateInput struct {
	// The inbox line this is a copy of. The line is the truth and this is one way
	// it was repeated.
	...
	// Skipped means a setting refused it, which is different from Failed and worth
	// telling apart in a report.
	State patch.Optional[RigNotificationDeliveryState] `json:"state"`
	// When this is due. A delivery held outside somebody hours moves to the next
	// opening; a digested one moves to its window close.
...
func (i *RigNotificationDeliveryUpdateInput) Normalize() {
	...
	if v, ok := i.State.Get(); ok {
		if parsed, ok := ParseRigNotificationDeliveryState(string(v)); ok {
			v = parsed
		}
...
func (i RigNotificationDeliveryUpdateInput) Merged(prev *RigNotificationDelivery) RigNotificationDelivery {
	out := *prev
...
// RigNotificationDeliveryUpdateInputError says what was wrong with each field
// of a RigNotificationDeliveryUpdateInput.
//
// Its shape is the input's shape, so a client can attach every message to the
// field it is about without matching on strings. A member is nil when that
// field was fine, and the whole value is nil when the input was. It is what
// the 422 carries.
type RigNotificationDeliveryUpdateInputError struct {
	// The inbox line this is a copy of. The line is the truth and this is one way
	// it was repeated.
	RecipientID *rigerr.FieldError `json:"recipientId,omitempty"`
	// Who it is for, denormalized off the line so a claim can group by it without
...
// Empty reports whether anything went wrong. A validator that found nothing
// returns nil rather than one of these.
func (e *RigNotificationDeliveryUpdateInputError) Empty() bool {
	if e == nil {
		return true
	}
...
// Error implements error. The sentence is for logs and for a person; the
// structure above is what a client acts on.
func (e *RigNotificationDeliveryUpdateInputError) Error() string {
	var parts []string
	if e.RecipientID != nil {
		parts = append(parts, "recipientId "+e.RecipientID.Error())
	}
...
// ErrorCode implements [rigerr.Coder]: the request was understood and its
// content is what is wrong, which is 422 and not 400.
func (e *RigNotificationDeliveryUpdateInputError) ErrorCode() rigerr.Code {
	return rigerr.CodeUnprocessableEntity
}

// ErrorFields implements [rigerr.FieldReporter], which is how the HTTP layer
// finds this and answers with it rather than with prose.
func (e *RigNotificationDeliveryUpdateInputError) ErrorFields() any { return e }
...
//
// What comes back is a *RigNotificationDeliveryUpdateInputError, shaped like
// the input itself.
func (i *RigNotificationDeliveryUpdateInput) Validate(prev *RigNotificationDelivery) error {
	var failed RigNotificationDeliveryUpdateInputError
...
// RigNotificationDeliveryDeleteInput is what deleting a
// RigNotificationDelivery takes.
type RigNotificationDeliveryDeleteInput struct {
	// ID is the row to delete.
	ID uuid.UUID `json:"id"`
}

// RigNotificationDeliveryValidatorContext is what a rule sees.
//
...
type RigNotificationDeliveryValidatorContext struct {
	// Values is the intended end state.
	Values RigNotificationDelivery
	...
	previous RigNotificationDelivery
	isUpdate bool
	changed  map[string]bool
}

// IsUpdate reports whether there was a row before this.
func (c *RigNotificationDeliveryValidatorContext) IsUpdate() bool { return c.isUpdate }

// Previous is the row as it was, and the zero value on a create. Check
// IsUpdate before reading it.
func (c *RigNotificationDeliveryValidatorContext) Previous() RigNotificationDelivery {
	return c.previous
}
...
// everything is new.
func (c *RigNotificationDeliveryValidatorContext) Changed(column string) bool {
	return c.changed[column]
}

// RecipientIDChanged reports whether this request set recipient_id.
func (c *RigNotificationDeliveryValidatorContext) RecipientIDChanged() bool {
	return c.changed[ColumnRigNotificationDeliveryRecipientID]
}

// AccountIDChanged reports whether this request set account_id.
func (c *RigNotificationDeliveryValidatorContext) AccountIDChanged() bool {
	return c.changed[ColumnRigNotificationDeliveryAccountID]
}

// ChannelChanged reports whether this request set channel.
func (c *RigNotificationDeliveryValidatorContext) ChannelChanged() bool {
	return c.changed[ColumnRigNotificationDeliveryChannel]
}

// KindChanged reports whether this request set kind.
func (c *RigNotificationDeliveryValidatorContext) KindChanged() bool {
	return c.changed[ColumnRigNotificationDeliveryKind]
}

// DigestChanged reports whether this request set digest.
func (c *RigNotificationDeliveryValidatorContext) DigestChanged() bool {
	return c.changed[ColumnRigNotificationDeliveryDigest]
}

// StateChanged reports whether this request set state.
func (c *RigNotificationDeliveryValidatorContext) StateChanged() bool {
	return c.changed[ColumnRigNotificationDeliveryState]
}

// DeliverAtChanged reports whether this request set deliver_at.
func (c *RigNotificationDeliveryValidatorContext) DeliverAtChanged() bool {
	return c.changed[ColumnRigNotificationDeliveryDeliverAt]
}

// SentAtChanged reports whether this request set sent_at.
func (c *RigNotificationDeliveryValidatorContext) SentAtChanged() bool {
	return c.changed[ColumnRigNotificationDeliverySentAt]
}

// FailedReasonChanged reports whether this request set failed_reason.
func (c *RigNotificationDeliveryValidatorContext) FailedReasonChanged() bool {
	return c.changed[ColumnRigNotificationDeliveryFailedReason]
}

// AttemptsChanged reports whether this request set attempts.
func (c *RigNotificationDeliveryValidatorContext) AttemptsChanged() bool {
	return c.changed[ColumnRigNotificationDeliveryAttempts]
}

// ClaimedAtChanged reports whether this request set claimed_at.
func (c *RigNotificationDeliveryValidatorContext) ClaimedAtChanged() bool {
	return c.changed[ColumnRigNotificationDeliveryClaimedAt]
}

// ClaimedByChanged reports whether this request set claimed_by.
func (c *RigNotificationDeliveryValidatorContext) ClaimedByChanged() bool {
	return c.changed[ColumnRigNotificationDeliveryClaimedBy]
}

// RigNotificationDeliveryCreateValidator is the rules for bringing a
// RigNotificationDelivery into existence: what the schema cannot express.
//
...
type RigNotificationDeliveryCreateValidator struct {
	// The inbox line this is a copy of. The line is the truth and this is one way
	// it was repeated.
	RecipientID func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value uuid.UUID) error
	// Who it is for, denormalized off the line so a claim can group by it without
	// a join.
	AccountID func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value uuid.UUID) error
	// Where it is going. One row per line per channel, which is what the unique
	// index below enforces.
	Channel func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value RigNotificationChannel) error
	// Copied from the notification, so the settings resolution needs no join
	// either.
	Kind func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value string) error
	// What the setting said when this row was written. Immediate rows are sent on
	// their own; the rest are batched per account and channel.
	Digest func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value RigNotificationDigest) error
	// Skipped means a setting refused it, which is different from Failed and worth
	// telling apart in a report.
	State func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value RigNotificationDeliveryState) error
	// When this is due. A delivery held outside somebody hours moves to the next
	// opening; a digested one moves to its window close.
	DeliverAt func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value time.Time) error
	// When a channel accepted it, which is not the same as it arriving.
	SentAt func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value *time.Time) error
	// What the channel said last time. Kept on a retry as well as on a failure, so
	// a pattern is visible before the cap is reached.
	FailedReason func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value *string) error
	// How many times this has been claimed. Past notifications.max_attempts it is
	// Failed and stops being claimed.
	Attempts func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value int) error
	// When a dispatcher took it. Past notifications.claim_ttl another one may,
	// which is what makes a crashed process recoverable.
	ClaimedAt func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value *time.Time) error
	// Which process holds the lease. A uuid generated once per process, with the
	// hostname beside it in the log line, so a stuck lease traces to a pod rather
	// than to a mystery.
	ClaimedBy func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value *uuid.UUID) error

	// Entity runs after the per-field hooks, for a rule that is about the row
	// rather than about one column.
	Entity func(ctx context.Context, c *RigNotificationDeliveryValidatorContext) error
}
...
func (v RigNotificationDeliveryCreateValidator) RunCreate(ctx context.Context, claims tenancy.Claims, i *RigNotificationDeliveryCreateInput) error {
	// Everything is new, so everything counts as changed.
	c := &RigNotificationDeliveryValidatorContext{Claims: claims, changed: map[string]bool{}}
	c.Values.RecipientID = i.RecipientID
	c.changed[ColumnRigNotificationDeliveryRecipientID] = true
	c.Values.AccountID = i.AccountID
	c.changed[ColumnRigNotificationDeliveryAccountID] = true
	c.Values.Channel = i.Channel
	c.changed[ColumnRigNotificationDeliveryChannel] = true
	c.Values.Kind = i.Kind
	c.changed[ColumnRigNotificationDeliveryKind] = true
	c.Values.Digest = i.Digest
	c.changed[ColumnRigNotificationDeliveryDigest] = true
	c.Values.State = i.State
	c.changed[ColumnRigNotificationDeliveryState] = true
	c.Values.DeliverAt = i.DeliverAt
	c.changed[ColumnRigNotificationDeliveryDeliverAt] = true
	c.Values.SentAt = i.SentAt
	c.changed[ColumnRigNotificationDeliverySentAt] = true
	c.Values.FailedReason = i.FailedReason
	c.changed[ColumnRigNotificationDeliveryFailedReason] = true
	c.Values.Attempts = i.Attempts
	c.changed[ColumnRigNotificationDeliveryAttempts] = true
	c.Values.ClaimedAt = i.ClaimedAt
	c.changed[ColumnRigNotificationDeliveryClaimedAt] = true
	c.Values.ClaimedBy = i.ClaimedBy
	c.changed[ColumnRigNotificationDeliveryClaimedBy] = true
...
func (v RigNotificationDeliveryCreateValidator) run(ctx context.Context, c *RigNotificationDeliveryValidatorContext) (*RigNotificationDeliveryCreateInputError, error) {
	var failed RigNotificationDeliveryCreateInputError
...
// RigNotificationDeliveryUpdateValidator is the rules for changing one that
...
// A hook returns a FieldError to attach the message to a specific field, or
// any other error to fail the request outright.
type RigNotificationDeliveryUpdateValidator struct {
	// The inbox line this is a copy of. The line is the truth and this is one way
	// it was repeated.
	RecipientID func(ctx context.Context, c *RigNotificationDeliveryValidatorContext, value uuid.UUID) error
	// Who it is for, denormalized off the line so a claim can group by it without
...
func (v RigNotificationDeliveryUpdateValidator) RunUpdate(ctx context.Context, claims tenancy.Claims, i *RigNotificationDeliveryUpdateInput, prev *RigNotificationDelivery) error {
	c := &RigNotificationDeliveryValidatorContext{
	...
	c.changed[ColumnRigNotificationDeliveryRecipientID] = i.RecipientID.IsSet()
	c.changed[ColumnRigNotificationDeliveryAccountID] = i.AccountID.IsSet()
	c.changed[ColumnRigNotificationDeliveryChannel] = i.Channel.IsSet()
	c.changed[ColumnRigNotificationDeliveryKind] = i.Kind.IsSet()
	c.changed[ColumnRigNotificationDeliveryDigest] = i.Digest.IsSet()
	c.changed[ColumnRigNotificationDeliveryState] = i.State.IsSet()
	c.changed[ColumnRigNotificationDeliveryDeliverAt] = i.DeliverAt.IsSet()
	c.changed[ColumnRigNotificationDeliverySentAt] = i.SentAt.Touched()
	c.changed[ColumnRigNotificationDeliveryFailedReason] = i.FailedReason.Touched()
	c.changed[ColumnRigNotificationDeliveryAttempts] = i.Attempts.IsSet()
	c.changed[ColumnRigNotificationDeliveryClaimedAt] = i.ClaimedAt.Touched()
	c.changed[ColumnRigNotificationDeliveryClaimedBy] = i.ClaimedBy.Touched()
...
// their input, so it comes back wrapped with the rule that could not be run,
// keeping whatever code it carried and becoming Internal if it carried none.
func (v RigNotificationDeliveryUpdateValidator) run(ctx context.Context, c *RigNotificationDeliveryValidatorContext) (*RigNotificationDeliveryUpdateInputError, error) {
	var failed RigNotificationDeliveryUpdateInputError
