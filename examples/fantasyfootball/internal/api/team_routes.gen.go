...
func registerTeam(mux *http.ServeMux, s Server, svc TeamService) {
	...
	mux.HandleFunc("GET /api/v1/teams/_deleted", handleListDeletedTeams(s, svc))
	...
	mux.HandleFunc("POST /api/v1/teams/{id}/_restore", handleRestoreTeam(s, svc))
}
...
func handleListTeams(s Server, svc TeamService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		r, span := observe.Server(r, "GET /api/v1/teams", rec.Status)
		defer span.End()
...
func handleCreateTeam(s Server, svc TeamService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		r, span := observe.Server(r, "POST /api/v1/teams", rec.Status)
		defer span.End()
...
func handleSearchTeams(s Server, svc TeamService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		r, span := observe.Server(r, "QUERY /api/v1/teams", rec.Status)
		defer span.End()
...
// handleListDeletedTeams serves GET /api/v1/teams/_deleted.
//
// List retired Teams.
//
...
func handleListDeletedTeams(s Server, svc TeamService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		r, span := observe.Server(r, "GET /api/v1/teams/_deleted", rec.Status)
		defer span.End()
		...
		var query TeamListDeletedQuery
		limitParam, err := httpx.QueryInt(r, "limit", 50)
		if err != nil {
			fail(s, w, r, rc, err)
			return
...
func handleDeleteTeam(s Server, svc TeamService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		r, span := observe.Server(r, "DELETE /api/v1/teams/{id}", rec.Status)
		defer span.End()
...
func handleGetTeam(s Server, svc TeamService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		r, span := observe.Server(r, "GET /api/v1/teams/{id}", rec.Status)
		defer span.End()
...
func handleUpdateTeam(s Server, svc TeamService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		r, span := observe.Server(r, "PATCH /api/v1/teams/{id}", rec.Status)
		defer span.End()
...
// handleRestoreTeam serves POST /api/v1/teams/{id}/_restore.
//
...
func handleRestoreTeam(s Server, svc TeamService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		r, span := observe.Server(r, "POST /api/v1/teams/{id}/_restore", rec.Status)
		defer span.End()
