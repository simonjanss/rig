...
// Shape narrows RigNotificationRecipient's live-sync subscription.
//
...
// touches it again.
func Shape(ctx context.Context, r *http.Request, claims tenancy.Claims, p internalelectric.RigNotificationRecipientShapeParams, w *electric.Where) error {
...
// value nobody reads.
var _ internalelectric.RigNotificationRecipientScope = Shape
