...
// Package client is the generated Go client for the linearlite API, version
// v1. One method per endpoint, grouped by resource: c.New(...) then
...
const (
	...
	ServerLocal = "http://localhost:8084"
)
