...
//
// It is the one definition of a RigNotificationRecipient: the repository scans
...
type RigNotificationRecipient struct {
...
// TableRigNotificationRecipient is the table this entity is stored in.
const TableRigNotificationRecipient = "rig_notification_recipient"

// Column names for rig_notification_recipient, so nothing has to spell one
// out.
const (
	ColumnRigNotificationRecipientID                 = "id"
	ColumnRigNotificationRecipientTenantID           = "tenant_id"
	ColumnRigNotificationRecipientNotificationID     = "notification_id"
	ColumnRigNotificationRecipientAccountID          = "account_id"
	ColumnRigNotificationRecipientCreatedAt          = "created_at"
	ColumnRigNotificationRecipientUpdatedAt          = "updated_at"
	ColumnRigNotificationRecipientDeletedAt          = "deleted_at"
	ColumnRigNotificationRecipientDeletedByAccountID = "deleted_by_account_id"
	ColumnRigNotificationRecipientKind               = "kind"
	ColumnRigNotificationRecipientGroupKey           = "group_key"
	ColumnRigNotificationRecipientEventCount         = "event_count"
	ColumnRigNotificationRecipientReadAt             = "read_at"
)

// RigNotificationRecipientColumns is every column, in the order the row is
// scanned.
var RigNotificationRecipientColumns = []string{"id", "tenant_id", "notification_id", "account_id", "created_at", "updated_at", "deleted_at", "deleted_by_account_id", "kind", "group_key", "event_count", "read_at"}
