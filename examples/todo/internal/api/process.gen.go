...
//
// For this project that is 25s: 15s for the notification engine and 10s left
// over. That is also the number that belongs in Kubernetes'
...
func ShutdownBudget() time.Duration {
	return notificationsShutdown + shutdownHeadroom
}
