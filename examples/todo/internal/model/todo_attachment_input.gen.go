...
func (e *TodoAttachmentCreateInputError) Empty() bool {
	...
	return e.TodoID == nil && e.AttachmentFileID == nil && e.Caption == nil && e.Position == nil && e.Entity == nil
}
...
type TodoAttachmentUpdateInput struct {
	...
	// Where this sits in the todo's list of attachments.
	Position patch.Optional[int] `json:"position"`
}
...
func (c *TodoAttachmentValidatorContext) PositionChanged() bool {
	return c.changed[ColumnTodoAttachmentPosition]
}
...
type TodoAttachmentCreateValidator struct {
	...
	// Where this sits in the todo's list of attachments.
	Position func(ctx context.Context, c *TodoAttachmentValidatorContext, value int) error
...
func (v TodoAttachmentCreateValidator) RunCreate(ctx context.Context, claims tenancy.Claims, i *TodoAttachmentCreateInput) error {
	...
	c.changed[ColumnTodoAttachmentPosition] = true
...
func (v TodoAttachmentUpdateValidator) RunUpdate(ctx context.Context, claims tenancy.Claims, i *TodoAttachmentUpdateInput, prev *TodoAttachment) error {
	...
	c.changed[ColumnTodoAttachmentPosition] = i.Position.IsSet()
